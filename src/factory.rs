...
impl Factory {
    ...
    pub fn new() -> Result<Factory, D2D1Error> {
        ...
        unsafe {
            let hr =
                d2d1.create_factory(D2D1_FACTORY_TYPE_MULTI_THREADED,
                                    &ptr.iid(),
    ...
    pub fn create_rectangle_geometry(&self,
        ...
        unsafe {
            ...
            let result = (*self.ptr.raw_value())
                .CreateRectangleGeometry(&rectangle.0, ptr.raw_addr());
    ...
    pub fn create_rounded_rectangle_geometry(&self,
    ...
    pub fn create_ellipse_geometry(&self,
    ...
    pub fn create_geometry_group<G: geometry::Geometry>(&self,
        ...
        unsafe {
            ...
            let result = (*self.ptr.raw_value())
                .CreateGeometryGroup(D2D1_FILL_MODE(fill_mode as u32),
                                     ptrs.as_mut_ptr(),
                                     ptrs.len() as u32,
                                     ptr.raw_addr());
    ...
    pub fn create_stroke_style(&self,
    ...
    pub fn create_render_target<T: RenderTargetBacking>(&self,
                                                        backing: T)
